...
const equivalentMutantLocations = Object.freeze([
  ...
  exactLocations(330, 5, 330, 21),
  exactLocations(351, 5, 351, 32, 431, 5, 431, 32, 642, 5, 642, 32),
  exactLocations(375, 32, 375, 58),
  exactLocations(431, 5, 433, 25),
  exactLocations(431, 5, 433, 25),
  exactLocations(431, 5, 432, 34),
  exactLocations(431, 5, 432, 34),
  exactLocations(432, 5, 432, 34),
  exactLocations(487, 70, 487, 88, 520, 79, 520, 97),
  exactLocations(520, 7, 520, 25),
  exactLocations(772, 11, 774, 4),
  exactLocations(793, 7, 793, 25),
  exactLocations(841, 5, 841, 30),
  ...
  exactLocations(46, 39, 46, 49, 46, 39, 46, 49),
  exactLocations(127, 10, 127, 35),
  exactLocations(333, 10, 333, 35),
  exactLocations(333, 10, 333, 61),
  exactLocations(342, 7, 342, 14),
  exactLocations(348, 5, 348, 32),
  exactLocations(380, 13, 380, 17),
  exactLocations(465, 11, 465, 29, 465, 11, 465, 29),
  exactLocations(465, 11, 465, 29),
  exactLocations(478, 7, 478, 32),
  exactLocations(478, 7, 479, 29),
  exactLocations(843, 7, 843, 35),
  exactLocations(1037, 22, 1037, 45),
...
const recorderEquivalentMutantGroups = Object.freeze([
  ...
  },
  {
    ...
    mutants: [
      ...
      ['1850', 'ArrayDeclaration', '}, []);', '["Stryker was here"]', 2178, 6, 2178, 8],
      ['1936', 'ArrayDeclaration', '}, []);', '["Stryker was here"]', 2259, 6, 2259, 8],
    ],
  },
  {
    reason:
  ...
  },
  {
    ...
    mutants: [
      ...
      ['1935', 'BooleanLiteral', 'active = false;', 'true', 2256, 16, 2256, 21],
      [
        '2167',
        'ConditionalExpression',
  ...
  },
  {
    ...
    mutants: [
      ['1910', 'BooleanLiteral', 'mountedRef.current = false;', 'true', 2224, 28, 2224, 33],
    ],
  },
  {
    reason:
  ...
  },
  {
    ...
    mutants: [
      ...
      ['1480', 'BooleanLiteral', 'if (!isCurrent()) return false;', 'true', 1787, 36, 1787, 41],
    ],
  },
  {
    reason:
  ...
  },
  {
    ...
    mutants: [
      ['1714', 'ConditionalExpression', 'if (isCurrent()) {', 'true', 2011, 23, 2011, 34],
      ['1778', 'ConditionalExpression', 'if (!isCurrent()) return;', 'false', 2068, 25, 2068, 37],
    ],
  },
  {
    reason:
  ...
  },
  {
    ...
    mutants: [
      ['2037', 'ConditionalExpression', 'pulseSteps.length !== 2 ||', 'false', 2332, 7, 2332, 30],
      [
        '2039',
        'ConditionalExpression',
      ...
      ['2053', 'ConditionalExpression', 'step.duration <= 0 ||', 'false', 2337, 11, 2337, 29],
      [
        '2054',
        'EqualityOperator',
        'step.duration <= 0 ||',
  ...
  },
  {
    ...
    mutants: [['2198', 'ConditionalExpression', 'if (prompted) {', 'true', 2504, 11, 2504, 19]],
  },
  {
    reason:
  ...
  },
  {
    ...
    mutants: [
      ['2227', 'ConditionalExpression', 'if (mountedRef.current) {', 'true', 2524, 13, 2524, 31],
    ],
  },
  {
    reason:
    ...
    mutants: [
      ['2272', 'BooleanLiteral', 'await restoreOwnedAudioMode(false);', 'true', 2567, 37, 2567, 42],
      ['2280', 'BooleanLiteral', 'await restoreOwnedAudioMode(false);', 'true', 2582, 37, 2582, 42],
    ],
  },
  {
    reason:
  ...
  },
  {
    ...
    mutants: [['2304', 'BooleanLiteral', 'prepared = false;', 'true', 2615, 18, 2615, 23]],
  },
  {
    reason:
  ...
  },
  {
    ...
    mutants: [
      ['2456', 'ConditionalExpression', 'if (!uri) {', 'false', 2761, 9, 2761, 13],
      [
        '2458',
        'BlockStatement',
      ...
      ['2459', 'StringLiteral', "updatePhase('idle');", '""', 2762, 19, 2762, 25],
      [
        '2460',
        'StringLiteral',
        "callbacksRef.current.onError(translate('recorder.errNoRecording'));",
      ...
      ['2805', 'ConditionalExpression', 'if (!uri) return;', 'false', 3188, 11, 3188, 15],
    ],
  },
  {
    reason:
  ...
  },
  {
    ...
    mutants: [
      ['2638', 'BooleanLiteral', 'cancelRequestedRef.current = false;', 'true', 2989, 40, 2989, 45],
      ['2650', 'BooleanLiteral', 'cancelRequestedRef.current = false;', 'true', 3003, 38, 3003, 43],
    ],
  },
  {
    reason:
    ...
    mutants: [
      ...
      ['2701', 'ConditionalExpression', 'if (requestId) {', 'true', 3056, 15, 3056, 24],
    ],
  },
  {
    reason:
  ...
  },
  {
    ...
    mutants: [
      ['2753', 'ConditionalExpression', 'if (!controller) return;', 'false', 3126, 9, 3126, 20],
    ],
  },
  {
    reason:
  ...
  },
  {
    ...
    mutants: [
      ['2858', 'ConditionalExpression', 'if (!player) return;', 'false', 3252, 9, 3252, 16],
    ],
  },
]);
/**
