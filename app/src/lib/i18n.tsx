...
const en = {
  ...
  'feedback.wordFair': 'Close',
  'feedback.wordPoor': 'Practice',
  'welcome.speakTitle': 'Speak, not study',
  'welcome.speakBody': 'Answer real questions with your voice. Just tap the microphone and talk.',
  'welcome.feedbackTitle': 'Instant AI feedback',
  'welcome.feedbackBody':
    'See your score and exactly which words to practice, right after every answer.',
...
const te: Record<MessageKey, string> = {
  ...
  'password.strengthWeak': 'బలహీనం',
  'password.strengthFair': 'మంచిది',
  'password.strengthStrong': 'బలమైనది',
  ...
  'feedback.wordPoor': 'ప్రాక్టీస్ చేయండి',
  'welcome.speakTitle': 'మాట్లాడండి — కేవలం చదువు కాదు',
  'welcome.speakBody': 'మీ స్వరంతో నిజమైన ప్రశ్నలకు సమాధానం చెప్పండి. మైక్ నొక్కి మాట్లాడినంతే.',
  'welcome.feedbackTitle': 'వెంటనే AI ఫీడ్‌బ్యాక్',
  'welcome.feedbackBody':
    'ప్రతి సమాధానం తర్వాత మీ స్కోరు మరియు ఏ పదాలు ప్రాక్టీస్ చేయాలో వెంటనే చూడండి.',
  'welcome.levelTitle': 'మీ స్థాయి తెలుసుకోండి',
  'welcome.levelBody': 'ఒక చిన్న స్పీకింగ్ టెస్ట్ A1 నుంచి C2 వరకు మీ స్థాయిని నిర్ణయిస్తుంది.',
  'welcome.getStarted': 'మొదలుపెట్టండి',
...
const hi: Record<MessageKey, string> = {
  ...
  'password.strengthWeak': 'कमज़ोर',
  'password.strengthFair': 'ठीक',
  'password.strengthStrong': 'मज़बूत',
  ...
  'feedback.wordPoor': 'अभ्यास करें',
  'welcome.speakTitle': 'बोलिए — सिर्फ़ पढ़ना नहीं',
  'welcome.speakBody': 'अपनी आवाज़ से असली सवालों के जवाब दें। बस माइक दबाएँ और बोलें।',
  'welcome.feedbackTitle': 'तुरंत AI फ़ीडबैक',
  'welcome.feedbackBody': 'हर जवाब के बाद अपना स्कोर और कौन से शब्द सुधारने हैं, तुरंत देखें।',
  'welcome.levelTitle': 'अपना स्तर जानें',
  'welcome.levelBody': 'एक छोटी बोलकर बताने वाली टेस्ट आपका स्तर A1 से C2 तक तय करती है।',
  ...
  'home.streakLabel': 'दिनों की स्ट्रीक',
...
const es: Record<MessageKey, string> = {
  ...
  'password.strengthStrong': 'Fuerte',
  ...
  'feedback.wordPoor': 'Practica',
  'welcome.speakTitle': 'Habla, no estudies',
  'welcome.speakBody': 'Responde preguntas reales con tu voz. Solo toca el micrófono y habla.',
  'welcome.feedbackTitle': 'Feedback instantáneo con IA',
  'welcome.feedbackBody': 'Ve tu puntaje y qué palabras practicar justo después de cada respuesta.',
  'welcome.levelTitle': 'Encuentra tu nivel',
  'welcome.levelBody': 'Un breve test oral te ubica de A1 a C2, y la práctica se adapta a ti.',
  ...
  'home.streakLabel': 'Días seguidos',
...
const zh: Record<MessageKey, string> = {
  ...
  'password.strengthWeak': '弱',
  'password.strengthFair': '一般',
  'password.strengthStrong': '强',
  ...
  'feedback.wordPoor': '多练习',
  'welcome.speakTitle': '开口说，不只是学',
  'welcome.speakBody': '用你的声音回答真实问题。轻点麦克风，开口即可。',
  'welcome.feedbackTitle': '即时 AI 反馈',
  'welcome.feedbackBody': '每次回答后立即看到分数，以及需要练习的单词。',
  'welcome.levelTitle': '找到你的水平',
  'welcome.levelBody': '一次简短的口语测试为你定位 A1 到 C2，练习随之适配。',
